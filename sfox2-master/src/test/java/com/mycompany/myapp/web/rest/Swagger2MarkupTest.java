...
/**
 * "Fake" integration test that generates a descrition of the REST API in asciidoc format.
 */
...
public class Swagger2MarkupTest {
    ...
    private String outputDirForFormat(String format) throws IOException {
        return new File(projectDir, "src/docs/" + format + "/generated").getAbsolutePath();
    }
